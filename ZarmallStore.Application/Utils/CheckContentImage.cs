...
namespace ZarmallStore.Application.Utils
{
    public static class CheckContentImage
    {
        ...
        {
            // Check if the file has a video content type
            var videoContentTypes = new[] { "video/mp4", "video/avi", "video/mov", "video/wmv", "video/mkv", "video/flv", "video/mpg", "video/mpeg" };
            ...
            var videoExtensions = new[] { ".mp4", ".avi", ".mov", ".wmv", ".mkv", ".flv", ".mpg", ".mpeg" };
